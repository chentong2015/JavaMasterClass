...
public class JavaFileLocation {
    ...
    private static String relativePath = "java-core-io/folder/location.txt";

    // TODO. 定义文件的绝对路径 -> "C:/java-core-io/folder/location.txt"
    private static String absolutePath = "/java-core-io/folder/location.txt";
    private static String absolutePathFull = "C:/Work/Work My Projects/Java Master/JavaMasterClass/java-core-io/folder/location.txt";
