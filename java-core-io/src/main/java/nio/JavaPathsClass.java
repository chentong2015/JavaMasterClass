...
public class JavaPathsClass {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Path txtFile = Paths.get("java-core-io/folder/SubFolder/text1.txt");
        Path txtFile1 = Paths.get("java-core-io", "folder", "SubFolder", "test1.txt");
        System.out.println(txtFile.toAbsolutePath());
        System.out.println(txtFile1.toAbsolutePath());

        // TODO. 定位当前项目路径下的相对目录
        Path baseFolder = Path.of("java-core-io/folder");
        System.out.println(Files.exists(baseFolder));

        // normalize()去掉路径中无效的"."目录
        String folder ="java-core-io\\folder\\.\\";
