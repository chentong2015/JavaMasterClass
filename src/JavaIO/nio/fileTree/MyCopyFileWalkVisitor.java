...
public class MyCopyFileWalkVisitor extends SimpleFileVisitor<Path> {

    private Path sourceRoot;
    private Path targetRoot;

    public MyCopyFileWalkVisitor(Path sourceRoot, Path targetRoot) {
