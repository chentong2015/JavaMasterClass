...
public abstract class JavaResourcesLoader {
    ...
    // TODO. 实例方法获取classpath资源路径下的文件, 包括依赖模块的classpath路径
    // 资源文件路径和this.getClass()当前类的路径一致(package)
    public File getFileFromClasspath() {
    ...
    // TODO. 静态方法获取classpath资源路径下的文件
    public static void getResourcesByStatic() {
        InputStream inputStream = JavaResourcesLoader.class
