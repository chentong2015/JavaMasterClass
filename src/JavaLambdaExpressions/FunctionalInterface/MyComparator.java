...
public interface MyComparator<T> {
    ...
    default MyComparator<T> thenComparing(MyComparator<T> newComparator) {
        return (p1, p2) -> compare(p1, p2) == 0 ? newComparator.compare(p1, p2) : compare(p1, p2);
    }

    // TODO: 通过thenComparing()方法实现了一个Builder效果，可以联系调用
    default MyComparator<T> thenComparing(Function<T, Comparable> function) {
    ...
    static <U> MyComparator<U> comparing(Function<U, ? extends Comparable> function) {
