...
public class CountDown {
    ...
    /**
     * 在For循环的过程中所操作的每一步，都可能因为线程的调度而中断
     * 在共享数据的过程中，Writing比Reading更容易造成错误
     * Thread 1 => 10
     * Thread 2 => 10
     * Thread 1 => 9
     * Thread 2 => 8
     ...
     * 使用"同步化"确保线程安全操作数据, 避免数据受到多个线程的interference干扰, 取消数据共享性, No interleave交错
     * 需要同步所有可能出现多线程interferences的地方 !!!
     */
     ...
     * 2. 什么对象可以作为同步锁；不能使用primitive type, 不是对象，没有固有的锁
     * 3.
     */
