 ...
 * 2. Critical Section: Shared resource like a variable, only one thread can execute critical section 共享资源的区域
...
public class BaseSynchronisation {
    ...
    private static void testThreadVariables() {
        ThreadShareVariables threadShareVariables = new ThreadShareVariables();
    ...
    private static void testSynchronisation() {
        ThreadShareVariables variables1 = new ThreadShareVariables();
        Thread thread1 = new Thread(variables1::doCountDown, "Thread 1");
        ThreadShareVariables variables2 = new ThreadShareVariables();
