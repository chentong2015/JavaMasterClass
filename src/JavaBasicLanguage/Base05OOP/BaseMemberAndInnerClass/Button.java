...
public class Button {
    ...
    // 嵌套接口
    // Inner interface 只关联Button的内部接口 !! --------------------------------------------------------------------------
    ...
    public static void main(String[] args) {
        ...
        // Inline class 匿名类型: class 没有名称，全部的声明都在 {} 之中 -----------------------------------------------------
        ...
        // TODO: 可以使用lambda表达式替换 接口中"唯一"声明的方法: 满足方法声明的原型 !!!! 有委托的含义 !!
        // void onClick(String title);
        // buttonPrint.setOnClickListener(title -> System.out.println(title + " was called "));
    }
}
