...
public class ClassLoaderResources {
    ...
    public static void getResourcesByStatic() {
        InputStream inputStream = ClassLoaderResources.class.getClassLoader().getResourceAsStream("filepath");
    ...
    public static void main(String[] args) {
        ...
        URL url = ClassLoaderResources.class.getClassLoader().getResource("resources/JavaResourcesLoader.class");
        System.out.println(url);

        // TODO. 返回.class文件被加载的根目录, 从jar中加载则会加上压缩文件路径
        // /target/JavaMasterClass/
        // /target/JavaMasterClass/file:...Demo.jar
        String filePath = ClassLoaderResources.class
                .getProtectionDomain()
                .getCodeSource()
                .getLocation()
                .getPath();
