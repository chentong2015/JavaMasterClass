package full.features.java9.internal.string;
...
public class Compaction {
    ...
    private static void printInternals(String hello) throws NoSuchFieldException, IllegalAccessException {
        ...
        switch (javaVersion.charAt(0)) {
            case '1':
                printInternalsInJava8(hello);
                break;
            case '9':
                printInternalsInJava9(hello);
                break;
            default:
                throw new IllegalStateException("Fancy Java version " + javaVersion);
        }
    }
