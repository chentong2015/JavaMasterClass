...
public class BaseJavaLock {

    public void testJavaLock() throws InterruptedException {
        DemoSynchronizedClass lockClass = new DemoSynchronizedClass();
