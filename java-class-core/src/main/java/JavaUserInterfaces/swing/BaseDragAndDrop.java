...
public class BaseDragAndDrop extends JPanel implements ActionListener {
    ...
    public BaseDragAndDrop() {
        ...
        list.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                System.out.println("Add clicked listener");
            }
        });
    ...
    private static void createAndShowGUI() {
        ...
        JComponent newContentPane = new BaseDragAndDrop();
