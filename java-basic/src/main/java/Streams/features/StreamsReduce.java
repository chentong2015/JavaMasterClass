...
import LambdaExpression.base.Employee;
...
public class StreamsReduce {
    ...
    public static void main(String[] args) {
        int[] value = {1, 2, 3, 4, 5};
        int total = Arrays.stream(value).reduce(0, Integer::sum);
        System.out.println(total);

        OptionalInt optionalInt = IntStream.of(1, 2, 3, 4, 5, 6).reduce(Integer::sum);
    ...
    // TODO. 自定义Reduce相邻元素Accumulator比较器/累计器
